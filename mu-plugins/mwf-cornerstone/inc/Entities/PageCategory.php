 ...
 */
class PageCategory extends WPCore\Abstracts\Mountable implements WPCore\Interfaces\Entities\Taxonomy
{
	/**
	...
	{
		$labels = [
			'name'                       => _x( 'Categories', 'Taxonomy General Name', 'mwf_cornerstone' ),
			'singular_name'              => _x( 'Category', 'Taxonomy Singular Name', 'mwf_cornerstone' ),
			'menu_name'                  => __( 'Categories', 'mwf_cornerstone' ),
