 ...
 * @since   1.0.0
 */
namespace Mwf\Cornerstone\Deps\Devkit\WPCore\DI;

use Mwf\Cornerstone\Deps\Devkit\WPCore\Helpers, Mwf\Cornerstone\Deps\Devkit\WPCore\Interfaces, Mwf\Cornerstone\Deps\Devkit\WPCore\Deps;
use Mwf\Cornerstone\Deps\DI\Definition\Source\DefinitionSource, Mwf\Cornerstone\Deps\DI\Definition\Reference, Mwf\Cornerstone\Deps\DI\Definition\StringDefinition, Mwf\Cornerstone\Deps\DI\Definition\ArrayDefinition, Mwf\Cornerstone\Deps\DI\Definition\ValueDefinition, Mwf\Cornerstone\Deps\DI\Definition\Helper;
 ...
 * @internal
 */
class ContainerBuilder extends \Mwf\Cornerstone\Deps\DI\ContainerBuilder
{
    /**
    ...
    protected function parseDefinitions(mixed $definition, string $key = '') : array
    {
        ...
        if (\is_array($definition)) {
            foreach ($definition as $nested_key => $nested_definition) {
                $definitions = \array_merge($definitions, $this->parseDefinitions($nested_definition, $nested_key));
            }
        } else {
    ...
    {
        return \Mwf\Cornerstone\Deps\DI\create($class_name);
    }
    /**
    ...
    {
        return \Mwf\Cornerstone\Deps\DI\get($class_name);
    }
    /**
    ...
    {
        return \Mwf\Cornerstone\Deps\DI\factory($factory);
    }
    /**
    ...
    {
        return \Mwf\Cornerstone\Deps\DI\decorate($decorator);
    }
    /**
    ...
    {
        return \Mwf\Cornerstone\Deps\DI\string($expression);
    }
    /**
    ...
    {
        return \Mwf\Cornerstone\Deps\DI\value($value);
    }
}
