 ...
 * @since   1.0.0
 */
namespace Mwf\Cornerstone\Deps\Devkit\WPCore\Traits\Handlers;
...
trait Directory
{
    ...
    {
        return !empty($append) ? \untrailingslashit(\trailingslashit($base) . \ltrim($append, '/')) : \untrailingslashit($base);
    }
}
