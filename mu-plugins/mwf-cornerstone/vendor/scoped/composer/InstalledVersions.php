 ...
 */
namespace Mwf\Cornerstone\Deps\Composer;

use Mwf\Cornerstone\Deps\Composer\Autoload\ClassLoader;
use Mwf\Cornerstone\Deps\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    public static function getInstalledPackages()
    {
        ...
        return \array_keys(\array_flip(\call_user_func_array('Mwf\\Cornerstone\\Deps\\array_merge', $packages)));
    }
    /**
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Mwf\\Cornerstone\\Deps\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
