...
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\AddBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\AndBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\BitwiseAndBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\BitwiseOrBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\BitwiseXorBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\ConcatBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\DivBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\EndsWithBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\EqualBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\FloorDivBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\GreaterBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\GreaterEqualBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\HasEveryBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\HasSomeBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\InBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\LessBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\LessEqualBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\MatchesBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\ModBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\MulBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\NotEqualBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\NotInBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\OrBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\PowerBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\RangeBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\SpaceshipBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\StartsWithBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Binary\SubBinary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Filter\DefaultFilter;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\NullCoalesceExpression;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Test\ConstantTest;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Test\DefinedTest;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Test\DivisiblebyTest;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Test\EvenTest;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Test\NullTest;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Test\OddTest;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Test\SameasTest;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Unary\NegUnary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Unary\NotUnary;
use Mwf\Cornerstone\Deps\Twig\Node\Expression\Unary\PosUnary;
use Mwf\Cornerstone\Deps\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use Mwf\Cornerstone\Deps\Twig\TokenParser\ApplyTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\BlockTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\DeprecatedTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\DoTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\EmbedTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\ExtendsTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\FlushTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\ForTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\FromTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\IfTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\ImportTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\IncludeTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\MacroTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\SetTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\UseTokenParser;
use Mwf\Cornerstone\Deps\Twig\TokenParser\WithTokenParser;
...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            // formatting filters
            new TwigFilter('date', '\\Mwf\\Cornerstone\\Deps\\twig_date_format_filter', ['needs_environment' => \true]),
            new TwigFilter('date_modify', '\\Mwf\\Cornerstone\\Deps\\twig_date_modify_filter', ['needs_environment' => \true]),
            new TwigFilter('format', '\\Mwf\\Cornerstone\\Deps\\twig_sprintf'),
            new TwigFilter('replace', '\\Mwf\\Cornerstone\\Deps\\twig_replace_filter'),
            new TwigFilter('number_format', '\\Mwf\\Cornerstone\\Deps\\twig_number_format_filter', ['needs_environment' => \true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', '\\Mwf\\Cornerstone\\Deps\\twig_round'),
            // encoding
            new TwigFilter('url_encode', '\\Mwf\\Cornerstone\\Deps\\twig_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', '\\Mwf\\Cornerstone\\Deps\\twig_convert_encoding'),
            // string filters
            new TwigFilter('title', '\\Mwf\\Cornerstone\\Deps\\twig_title_string_filter', ['needs_environment' => \true]),
            new TwigFilter('capitalize', '\\Mwf\\Cornerstone\\Deps\\twig_capitalize_string_filter', ['needs_environment' => \true]),
            new TwigFilter('upper', '\\Mwf\\Cornerstone\\Deps\\twig_upper_filter', ['needs_environment' => \true]),
            new TwigFilter('lower', '\\Mwf\\Cornerstone\\Deps\\twig_lower_filter', ['needs_environment' => \true]),
            new TwigFilter('striptags', '\\Mwf\\Cornerstone\\Deps\\twig_striptags'),
            new TwigFilter('trim', '\\Mwf\\Cornerstone\\Deps\\twig_trim_filter'),
            new TwigFilter('nl2br', '\\Mwf\\Cornerstone\\Deps\\twig_nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', '\\Mwf\\Cornerstone\\Deps\\twig_spaceless', ['is_safe' => ['html']]),
            // array helpers
            new TwigFilter('join', '\\Mwf\\Cornerstone\\Deps\\twig_join_filter'),
            new TwigFilter('split', '\\Mwf\\Cornerstone\\Deps\\twig_split_filter', ['needs_environment' => \true]),
            new TwigFilter('sort', '\\Mwf\\Cornerstone\\Deps\\twig_sort_filter', ['needs_environment' => \true]),
            new TwigFilter('merge', '\\Mwf\\Cornerstone\\Deps\\twig_array_merge'),
            new TwigFilter('batch', '\\Mwf\\Cornerstone\\Deps\\twig_array_batch'),
            new TwigFilter('column', '\\Mwf\\Cornerstone\\Deps\\twig_array_column'),
            new TwigFilter('filter', '\\Mwf\\Cornerstone\\Deps\\twig_array_filter', ['needs_environment' => \true]),
            new TwigFilter('map', '\\Mwf\\Cornerstone\\Deps\\twig_array_map', ['needs_environment' => \true]),
            new TwigFilter('reduce', '\\Mwf\\Cornerstone\\Deps\\twig_array_reduce', ['needs_environment' => \true]),
            // string/array filters
            new TwigFilter('reverse', '\\Mwf\\Cornerstone\\Deps\\twig_reverse_filter', ['needs_environment' => \true]),
            new TwigFilter('length', '\\Mwf\\Cornerstone\\Deps\\twig_length_filter', ['needs_environment' => \true]),
            new TwigFilter('slice', '\\Mwf\\Cornerstone\\Deps\\twig_slice', ['needs_environment' => \true]),
            new TwigFilter('first', '\\Mwf\\Cornerstone\\Deps\\twig_first', ['needs_environment' => \true]),
            new TwigFilter('last', '\\Mwf\\Cornerstone\\Deps\\twig_last', ['needs_environment' => \true]),
            // iteration and runtime
            new TwigFilter('default', '\\Mwf\\Cornerstone\\Deps\\_twig_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', '\\Mwf\\Cornerstone\\Deps\\twig_get_array_keys_filter'),
        ];
    }
...
use Mwf\Cornerstone\Deps\Twig\Error\LoaderError;
use Mwf\Cornerstone\Deps\Twig\Error\RuntimeError;
use Mwf\Cornerstone\Deps\Twig\Extension\CoreExtension;
use Mwf\Cornerstone\Deps\Twig\Extension\SandboxExtension;
use Mwf\Cornerstone\Deps\Twig\Markup;
use Mwf\Cornerstone\Deps\Twig\Source;
use Mwf\Cornerstone\Deps\Twig\Template;
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('Mwf\\Cornerstone\\Deps\\Twig\\Extension\\SandboxExtension') && $env->getExtension('Mwf\\Cornerstone\\Deps\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
