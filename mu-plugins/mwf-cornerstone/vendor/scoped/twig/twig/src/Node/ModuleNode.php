...
use Mwf\Cornerstone\Deps\Twig\Node\Expression\AbstractExpression;
...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Environment;\n")->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Error\\LoaderError;\n")->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Error\\RuntimeError;\n")->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Extension\\SandboxExtension;\n")->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Markup;\n")->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Sandbox\\SecurityError;\n")->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Sandbox\\SecurityNotAllowedTagError;\n")->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Sandbox\\SecurityNotAllowedFilterError;\n")->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Sandbox\\SecurityNotAllowedFunctionError;\n")->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Source;\n")->write("use \\Mwf\\Cornerstone\\Deps\\Twig\\Template;\n\n");
        }
        $compiler->write('/* ' . \str_replace('*/', '* /', $this->getSourceContext()->getName()) . " */\n")->write('class ' .  \substr( $compiler->getEnvironment()->getTemplateClass($this->getSourceContext()->getName(), $this->getAttribute('index')), 22 ) )->raw(" extends Template\n")->write("{\n")->indent()->write("private \$source;\n")->write("private \$macros = [];\n\n");
    }
