...
class Helper
{
    ...
    public static function transient($slug, $callback, $transient_time = 0, $lock_timeout = 5, $force = \false)
    {
         ...
         */
        $slug = \apply_filters('mwf_cornerstone_timber/transient/slug', $slug);
        $enable_transients = $transient_time === \false || \defined('Mwf\\Cornerstone\\Deps\\WP_DISABLE_TRANSIENTS') && WP_DISABLE_TRANSIENTS ? \false : \true;
    ...
    protected static function handle_transient_locking($slug, $callback, $transient_time, $lock_timeout, $force, $enable_transients)
    {
        if ($enable_transients && self::_is_transient_locked($slug)) {
             ...
             * @param bool $force
             */
            $force = \apply_filters('mwf_cornerstone_timber/transient/force_transients', $force);
            /**
             * Filters …
             *
             * @todo Add summary
    ...
    public static function get_wp_title($separator = ' ', $seplocation = 'left')
    {
         ...
         */
        $separator = \apply_filters('mwf_cornerstone_timber/helper/wp_title_separator', $separator);
        /**
         * Filters the separator used for the page title.
         *
