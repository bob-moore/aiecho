...
use Mwf\Cornerstone\Deps\Timber\Image\Operation;
/**
 * Class ImageHelper
 *
...
class ImageHelper
{
    ...
    public static function set_sideload_image_upload_dir(array $upload)
    {
         ...
         * add_filter('mwf_cornerstone_timber/sideload_image/subdir', function( $subdir ) {
         *     return 'sideloaded';
         * } );
         *
         * // Disable subdirectory used for sideloaded images.
         * add_filter('mwf_cornerstone_timber/sideload_image/subdir', '__return_false' );
         * ```
         *
         ...
         *                       `external`.
         */
        $subdir = \apply_filters('mwf_cornerstone_timber/sideload_image/subdir', $subdir);
        if (!empty($subdir)) {
    ...
    private static function _get_file_url($base, $subdir, $filename, $absolute)
    {
        ...
        if (!$absolute) {
            $home = \home_url();
            $home = \apply_filters('mwf_cornerstone_timber/image_helper/_get_file_url/home_url', $home);
    ...
    private static function _operate($src, $op, $force = \false)
    {
        ...
        $allow_fs_write = \apply_filters('mwf_cornerstone_timber/allow_fs_write', \true);
         ...
         */
        $new_url = \apply_filters('mwf_cornerstone_timber/image/new_url', $new_url);
        /**
         ...
         */
        $destination_path = \apply_filters('mwf_cornerstone_timber/image/new_path', $destination_path);
        // if already exists...
