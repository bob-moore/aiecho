...
namespace Mwf\Cornerstone\Deps\Timber\Integration\CoAuthorsPlus;
...
class CoAuthorsPlusUser extends User
{
    ...
    {
        $prefer_gravatar = \apply_filters('mwf_cornerstone_timber/co_authors_plus/prefer_gravatar', \false);
        if ($prefer_gravatar) {
