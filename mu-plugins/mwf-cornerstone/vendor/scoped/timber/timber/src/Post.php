...
class Post extends CoreEntity implements DatedInterface, Setupable
{
    ...
    public static function build(WP_Post $wp_post) : self
    {
         ...
         */
        $data = \apply_filters('mwf_cornerstone_timber/post/import_data', $data, $post);
        $post->import($data);
        return $post;
    }
    /**
    ...
    public function field_object($field_name)
    {
         ...
         */
        $value = \apply_filters('mwf_cornerstone_timber/post/meta_object_field', null, $this->ID, $field_name, $this);
    ...
    public function authors()
    {
         ...
         * @param \Timber\Post $post    The post object.
         */
        return \apply_filters('mwf_cornerstone_timber/post/authors', [$this->author()], $this);
    }
    /**
    ...
    protected function maybe_show_password_form()
    {
        if ($this->password_required()) {
             ...
             * add_filter('mwf_cornerstone_timber/post/content/show_password_form_for_protected', '__return_true' );
             * ```
             *
             * @param bool $show_pw Whether the password form should be shown. Default `false`.
             */
            $show_pw = \apply_filters('mwf_cornerstone_timber/post/content/show_password_form_for_protected', $show_pw);
            if ($show_pw) {
                /**
                 ...
                 * add_filter('mwf_cornerstone_timber/post/content/password_form', function( $form, $post ) {
                 ...
                 * @param \Timber\Post $post The post object.
                 */
                return \apply_filters('mwf_cornerstone_timber/post/content/password_form', \get_the_password_form($this->ID), $this);
            }
        }
    }
    /**
