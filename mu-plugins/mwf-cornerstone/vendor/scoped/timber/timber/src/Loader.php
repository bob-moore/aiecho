...
use Mwf\Cornerstone\Deps\Timber\Cache\Cleaner;
use Mwf\Cornerstone\Deps\Twig\CacheExtension;
use Mwf\Cornerstone\Deps\Twig\Environment;
use Mwf\Cornerstone\Deps\Twig\Loader\FilesystemLoader;
...
class Loader
{
    ...
    public function __construct($caller = \false)
    {
         ...
         */
        $this->cache_mode = \apply_filters('mwf_cornerstone_timber/cache/mode', $this->cache_mode);
        /**
         * Filters the cache mode.
         *
    ...
    public function render($file, $data = null, $expires = \false, $cache_mode = self::CACHE_USE_DEFAULT)
    {
        ...
        if (\false === $output || null === $output) {
            ...
            if (\strlen($file)) {
                 ...
                 * @param string $result
                 */
                \do_action('mwf_cornerstone_timber/loader/render_file', $result);
                /**
                 * Fires after …
                 *
             ...
             * @param string $file
             */
            $data = \apply_filters('mwf_cornerstone_timber/loader/render_data', $data, $file);
            /**
             * Filters …
             *
             * @todo Add summary
         ...
         * @param string $file
         */
        $output = \apply_filters('mwf_cornerstone_timber/output', $output, $data, $file);
        /**
         * Filters …
         *
         * @todo Add summary
    ...
    public function get_loader()
    {
         ...
         * @param array $paths
         */
        $paths = \apply_filters_deprecated('mwf_cornerstone_timber/loader/paths', [$paths], '2.0.0', 'timber/locations');
         ...
         * @since 1.1.11
         */
        $fs = \apply_filters('mwf_cornerstone_timber/loader/loader', $fs);
        return $fs;
    }
    /**
    ...
    public function get_twig()
    {
         ...
         * @example
         * ```php
         * add_filter('mwf_cornerstone_timber/twig/environment/options', 'update_twig_environment_options' );
         *
         * /**
         ...
         */
        $environment_options = \apply_filters('mwf_cornerstone_timber/twig/environment/options', $environment_options);
        /**
         * @deprecated 2.0.0
         */
        ...
        if (\true === $environment_options['cache']) {
             ...
             */
            $twig_cache_loc = \apply_filters_deprecated('mwf_cornerstone_timber/cache/location', [$twig_cache_loc], '2.0.0', 'timber/twig/environment/options');
            if (!\file_exists($twig_cache_loc)) {
                \mkdir($twig_cache_loc, 0777, \true);
            }
            $environment_options['cache'] = $twig_cache_loc;
        }
        $twig = new \Mwf\Cornerstone\Deps\Twig\Environment($this->get_loader(), $environment_options);
        if (\WP_DEBUG) {
            $twig->addExtension(new \Mwf\Cornerstone\Deps\Twig\Extension\DebugExtension());
        } else {
         ...
         */
        $enable_cache_extension = \apply_filters('mwf_cornerstone_timber/cache/enable_extension', \true);
        if ($enable_cache_extension && \class_exists('Mwf\\Cornerstone\\Deps\\Twig\\CacheExtension\\Extension')) {
         ...
         */
        $twig = \apply_filters('mwf_cornerstone_timber/loader/twig', $twig);
        /**
         * Filters …
         *
         ...
         *  *\/
         * add_filter('mwf_cornerstone_timber/twig', function( $twig ) {
         ...
         */
        $twig = \apply_filters('mwf_cornerstone_timber/twig', $twig);
        /**
         * Filters the Twig environment used in the global context.
         *
         * @deprecated 2.0.0
    ...
    {
        $key_generator = new \Mwf\Cornerstone\Deps\Timber\Cache\KeyGenerator();
        $cache_provider = new \Mwf\Cornerstone\Deps\Timber\Cache\WPObjectCacheAdapter($this);
        $cache_lifetime = \apply_filters('mwf_cornerstone_timber/cache/extension/lifetime', 0);
