...
use Mwf\Cornerstone\Deps\Timber\Factory\CommentFactory;
use Mwf\Cornerstone\Deps\Timber\Factory\MenuFactory;
use Mwf\Cornerstone\Deps\Timber\Factory\PagesMenuFactory;
use Mwf\Cornerstone\Deps\Timber\Factory\PostFactory;
use Mwf\Cornerstone\Deps\Timber\Factory\TermFactory;
use Mwf\Cornerstone\Deps\Timber\Factory\UserFactory;
use Mwf\Cornerstone\Deps\Timber\Integration\IntegrationInterface;
use WP_Comment;
...
class Timber
{
    ...
    {
        \defined("Mwf\\Cornerstone\\Deps\\TIMBER_LOC") or \define("Mwf\\Cornerstone\\Deps\\TIMBER_LOC", \realpath(\dirname(__DIR__)));
    }
    /**
     * @codeCoverageIgnore
     */
    ...
    {
        if (!\defined('ABSPATH') || !\class_exists('\\WP') || \defined('Mwf\\Cornerstone\\Deps\\TIMBER_LOADED')) {
            return;
        }
        $self = new self();
        $self->init_constants();
        ...
        \add_filter('mwf_cornerstone_timber/post/import_data', [__CLASS__, 'handle_preview'], 10, 2);
        /**
         ...
         */
        \class_alias('Mwf\\Cornerstone\\Deps\\Timber\\Timber', 'Mwf\\Cornerstone\\Deps\\Timber');
        \define('Mwf\\Cornerstone\\Deps\\TIMBER_LOADED', \true);
    }
    /**
    ...
    public static function init_integrations() : void
    {
         ...
         */
        $integrations = \apply_filters('mwf_cornerstone_timber/integrations', $integrations);
    ...
    public static function context_global()
    {
        if (empty(self::$context_cache)) {
             ...
             * @example
             * ```php
             * add_filter('mwf_cornerstone_timber/context', function( $context ) {
             ...
             */
            self::$context_cache = \apply_filters('mwf_cornerstone_timber/context', self::$context_cache);
            /**
             * Filters the global Timber context.
             *
    ...
    {
        if (!\defined('Mwf\\Cornerstone\\Deps\\TIMBER_LOADED')) {
            self::init();
        }
         ...
         */
        \do_action('mwf_cornerstone_timber/calling_php_file', $caller_file);
        if ($via_render) {
            /**
             ...
             */
            $file = \apply_filters('mwf_cornerstone_timber/render/file', $file);
            /**
             ...
             */
            $file = \apply_filters('mwf_cornerstone_timber/compile/file', $file);
            /**
             * Filters the Twig template that should be compiled.
             *
             * @deprecated 2.0.0
        ...
        if ($file !== \false) {
            ...
            if ($via_render) {
                 ...
                 */
                $data = \apply_filters('mwf_cornerstone_timber/render/data', $data, $file);
                /**
                 * Filters the data that should be passed for rendering a Twig template.
                 *
                 * @codeCoverageIgnore
                 ...
                 */
                $data = \apply_filters('mwf_cornerstone_timber/compile/data', $data, $file);
                /**
                 * Filters the data that should be passed for compiling a Twig template.
                 *
         ...
         * @param string $output
         */
        $output = \apply_filters('mwf_cornerstone_timber/compile/result', $output);
        /**
         ...
         */
        \do_action('mwf_cornerstone_timber/compile/done', $output, $file, $data, $expires, $cache_mode);
        /**
         * Fires after a Twig template was compiled and before the compiled data
         * is returned.
         *
