...
use Mwf\Cornerstone\Deps\Timber\PagesMenu;
/**
...
class PagesMenuFactory
{
    ...
    protected function get_menu_class($args) : string
    {
         ...
         * @example
         * ```
         * add_filter('mwf_cornerstone_timber/pages_menu/class', function( $class ) {
         ...
         */
        $class = \apply_filters('mwf_cornerstone_timber/pages_menu/class', PagesMenu::class, $args);
