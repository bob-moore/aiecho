...
class MenuFactory
{
    ...
    protected function get_menu_class($term, $args) : string
    {
         ...
         * @example
         * ```
         * add_filter('mwf_cornerstone_timber/menu/classmap', function( $classmap ) {
         *     $custom_classmap = [
         ...
         */
        $classmap = \apply_filters('mwf_cornerstone_timber/menu/classmap', []);
         ...
         * @example
         * ```
         * add_filter('mwf_cornerstone_timber/menu/class', function( $class, $term, $args ) {
         *     if ( $args['depth'] === 1 ) {
         ...
         */
        $class = \apply_filters('mwf_cornerstone_timber/menu/class', $class, $term, $args);
        return $class;
    }
    /**
