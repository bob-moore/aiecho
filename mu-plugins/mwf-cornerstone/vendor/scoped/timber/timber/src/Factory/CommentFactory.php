...
use Mwf\Cornerstone\Deps\Timber\Comment;
...
class CommentFactory
{
    ...
    protected function get_comment_class(WP_Comment $comment) : string
    {
        ...
        $map = \apply_filters('mwf_cornerstone_timber/comment/classmap', []);
         ...
         * @example
         * ```
         * add_filter('mwf_cornerstone_timber/comment/class', function( $class, $comment ) {
         ...
         */
        $class = \apply_filters('mwf_cornerstone_timber/comment/class', $class, $comment);
        return $class;
    }
