...
use Mwf\Cornerstone\Deps\Timber\Term;
use WP_Term;
use WP_Term_Query;
/**
...
class TermFactory
{
    ...
    protected function get_term_class(WP_Term $term) : string
    {
        ...
        $map = \apply_filters('mwf_cornerstone_timber/term/classmap', ['post_tag' => Term::class, 'category' => Term::class]);
         ...
         * @example
         * ```
         * add_filter('mwf_cornerstone_timber/term/class', function( $class, $term ) {
         ...
         */
        $class = \apply_filters('mwf_cornerstone_timber/term/class', $class, $term);
        return $class;
    }
