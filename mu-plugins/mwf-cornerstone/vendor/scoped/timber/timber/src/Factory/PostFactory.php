...
namespace Mwf\Cornerstone\Deps\Timber\Factory;

use InvalidArgumentException;
use Mwf\Cornerstone\Deps\Timber\Attachment;
use Mwf\Cornerstone\Deps\Timber\CoreInterface;
use Mwf\Cornerstone\Deps\Timber\Helper;
use Mwf\Cornerstone\Deps\Timber\Image;
use Mwf\Cornerstone\Deps\Timber\PathHelper;
use Mwf\Cornerstone\Deps\Timber\Post;
use Mwf\Cornerstone\Deps\Timber\PostArrayObject;
use Mwf\Cornerstone\Deps\Timber\PostQuery;
use WP_Post;
use WP_Query;
/**
...
class PostFactory
{
    ...
    protected function get_post_class(WP_Post $post) : string
    {
         ...
         */
        if ('deprecated' !== \apply_filters('Mwf\\Cornerstone\\Deps\\Timber\\PostClassMap', 'deprecated')) {
         ...
         * use Page;
         *
         * add_filter('mwf_cornerstone_timber/post/classmap', function( $classmap ) {
         *     $custom_classmap = [
         *         'page' => Page::class,
         *         'book' => Book::class,
         *     ];
         ...
         */
        $classmap = \apply_filters('mwf_cornerstone_timber/post/classmap', [
            'post' => Post::class,
            'page' => Post::class,
         ...
         * @example
         * ```
         * add_filter('mwf_cornerstone_timber/post/class', function( $class, $post ) {
         *     if ( has_blocks($post) ) {
         ...
         */
        $class = \apply_filters('mwf_cornerstone_timber/post/class', $class, $post);
        return $class;
    }
    protected function is_image(WP_Post $post)
    {
        ...
        $extensions = \apply_filters('mwf_cornerstone_timber/post/image_extensions', ['jpg', 'jpeg', 'jpe', 'gif', 'png', 'svg', 'webp']);
