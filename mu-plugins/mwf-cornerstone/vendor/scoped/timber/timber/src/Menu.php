...
use Throwable;
use Mwf\Cornerstone\Deps\Timber\Factory\MenuItemFactory;
use WP_Term;
/**
 * Class Menu
 *
...
class Menu extends CoreEntity
{
    ...
    public static function build(?WP_Term $menu, $args = []) : ?self
    {
         ...
         * @example
         * ```
         * add_filter('mwf_cornerstone_timber/menu/item_objects', function ( $items ) {
         ...
         * @param WP_Term $menu
         */
        $sorted_menu_items = \apply_filters('mwf_cornerstone_timber/menu/item_objects', $sorted_menu_items, $menu);
        // Create Menu object
