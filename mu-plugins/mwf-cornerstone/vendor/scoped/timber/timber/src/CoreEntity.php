...
abstract class CoreEntity extends Core implements CoreInterface, CoreEntityInterface, MetaInterface
{
    ...
    protected function fetch_meta($field_name = '', $args = [], $apply_filters = \true)
    {
         ...
         * add_filter('mwf_cornerstone_timber/meta/transform_value', '__return_true' );
         * ```
         *
         * @param bool $transform_value
         */
        $transform_value = \apply_filters('mwf_cornerstone_timber/meta/transform_value', \false);
        ...
        if ($apply_filters) {
             ...
             * add_filter('mwf_cornerstone_timber/post/pre_meta', '__return_false' );
             *
             * // Add your own meta data.
             * add_filter('mwf_cornerstone_timber/post/pre_meta', function( $post_meta, $post_id, $post ) {
        ...
        if ($apply_filters) {
             ...
             * @example
             * ```php
             * add_filter('mwf_cornerstone_timber/post/meta', function( $post_meta, $post_id, $field_name, $post ) {
            ...
            if ($object_type === 'term') {
                 ...
                 */
                $object_meta = \apply_filters_deprecated('mwf_cornerstone_timber/term/meta/field', [$object_meta, $this->ID, $field_name, $this], '2.0.0', 'timber/term/meta');
            }
            /**
