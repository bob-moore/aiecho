...
class URLHelper
{
    ...
    public static function url_to_file_system($url)
    {
         ...
         * @param string $path
         */
        $url_parts['path'] = \apply_filters('mwf_cornerstone_timber/url_helper/url_to_file_system/path', $url_parts['path']);
        /**
         * Filters the path of a parsed URL.
         *
         * @deprecated 2.0.0, use `timber/url_helper/url_to_file_system/path`
         */
        $url_parts['path'] = \apply_filters_deprecated('mwf_cornerstone_timber/URLHelper/url_to_file_system/path', [$url_parts['path']], '2.0.0', 'timber/url_helper/url_to_file_system/path');
    ...
    public static function file_system_to_url($fs)
    {
         ...
         */
        $home = \apply_filters('mwf_cornerstone_timber/url_helper/file_system_to_url', $home);
        /**
         * Filters the home URL …
         *
         ...
         */
        $home = \apply_filters_deprecated('mwf_cornerstone_timber/URLHelper/file_system_to_url', [$home], '2.0.0', 'timber/url_helper/file_system_to_url');
        return $home;
    }
    /**
    ...
    public static function get_content_subdir()
    {
         ...
         */
        $home_url = \apply_filters('mwf_cornerstone_timber/url_helper/get_content_subdir/home_url', $home_url);
        /**
         * Filters the home URL that is used to get the path relative to the content directory.
         *
         * @deprecated 2.0.0, use `timber/url_helper/get_content_subdir/home_url`
         */
        $home_url = \apply_filters_deprecated('mwf_cornerstone_timber/URLHelper/get_content_subdir/home_url', [$home_url], '2.0.0', 'timber/url_helper/get_content_subdir/home_url');
    ...
    {
        $url = \str_replace('//', '/', $url);
        $schemes_whitelist = \apply_filters('mwf_cornerstone_timber/url/schemes-whitelist', ['http', 'https', 's3', 'gs']);
