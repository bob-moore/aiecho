...
class Twig
{
    ...
    {
        $self = new self();
        \add_filter('mwf_cornerstone_timber/twig', [$self, 'add_timber_functions']);
        \add_filter('mwf_cornerstone_timber/twig', [$self, 'add_timber_filters']);
        \add_filter('mwf_cornerstone_timber/twig', [$self, 'add_timber_escapers']);
        \add_filter('mwf_cornerstone_timber/loader/twig', [$self, 'set_defaults']);
    }
    /**
    ...
    public function get_timber_functions()
    {
         ...
         * @example
         * ```php
         * add_filter('mwf_cornerstone_timber/twig/functions', function( $functions ) {
         ...
         */
        $functions = \apply_filters('mwf_cornerstone_timber/twig/functions', $functions);
        return $functions;
    }
    /**
    ...
    public function get_timber_filters()
    {
        $filters = [
            /* image filters */
            'resize' => ['callable' => ['Mwf\\Cornerstone\\Deps\\Timber\\ImageHelper', 'resize']],
            'retina' => ['callable' => ['Mwf\\Cornerstone\\Deps\\Timber\\ImageHelper', 'retina_resize']],
            'letterbox' => ['callable' => ['Mwf\\Cornerstone\\Deps\\Timber\\ImageHelper', 'letterbox']],
            'tojpg' => ['callable' => ['Mwf\\Cornerstone\\Deps\\Timber\\ImageHelper', 'img_to_jpg']],
            'towebp' => ['callable' => ['Mwf\\Cornerstone\\Deps\\Timber\\ImageHelper', 'img_to_webp']],
            // Debugging filters.
            ...
            'excerpt_chars' => ['callable' => ['Mwf\\Cornerstone\\Deps\\Timber\\TextHelper', 'trim_characters']],
            'function' => ['callable' => [$this, 'exec_function']],
            ...
            'pluck' => ['callable' => ['Mwf\\Cornerstone\\Deps\\Timber\\Helper', 'pluck']],
            'wp_list_filter' => ['callable' => ['Mwf\\Cornerstone\\Deps\\Timber\\Helper', 'wp_list_filter']],
            ...
            'time_ago' => ['callable' => ['Mwf\\Cornerstone\\Deps\\Timber\\DateTimeHelper', 'time_ago']],
         ...
         * @example
         * ```php
         * add_filter('mwf_cornerstone_timber/twig/default_filters', function( $filters ) {
         *     // Add your own filter.
         *     $filters['price'] = [
         ...
         * @param array $filters
         */
        $filters = \apply_filters('mwf_cornerstone_timber/twig/filters', $filters);
        return $filters;
    }
    /**
    ...
    public function add_timber_escapers($twig)
    {
        ...
        if (\class_exists('Mwf\\Cornerstone\\Deps\\Twig\\Extension\\EscaperExtension')) {
            $escaper_extension = $twig->getExtension('Mwf\\Cornerstone\\Deps\\Twig\\Extension\\EscaperExtension');
