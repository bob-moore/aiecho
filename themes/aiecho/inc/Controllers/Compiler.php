...
class Compiler extends WPCore\Abstracts\Mountable implements WPCore\Interfaces\Controller
{
	...
	{
		add_filter( "{$this->package}_timber/twig/functions", [ $this, 'twigFunctions' ] );
		add_filter( "{$this->package}_timber/twig/filters", [ $this, 'twigFilters' ] );
	}
	/**
