...
use Mwf\ChildTheme\Deps\Timber\Factory\CommentFactory;
use Mwf\ChildTheme\Deps\Timber\Factory\MenuFactory;
use Mwf\ChildTheme\Deps\Timber\Factory\PagesMenuFactory;
use Mwf\ChildTheme\Deps\Timber\Factory\PostFactory;
use Mwf\ChildTheme\Deps\Timber\Factory\TermFactory;
use Mwf\ChildTheme\Deps\Timber\Factory\UserFactory;
use Mwf\ChildTheme\Deps\Timber\Integration\IntegrationInterface;
use WP_Comment;
...
class Timber
{
    ...
    {
        \defined("Mwf\\ChildTheme\\Deps\\TIMBER_LOC") or \define("Mwf\\ChildTheme\\Deps\\TIMBER_LOC", \realpath(\dirname(__DIR__)));
    }
    /**
     * @codeCoverageIgnore
     */
    ...
    {
        if (!\defined('ABSPATH') || !\class_exists('\\WP') || \defined('Mwf\\ChildTheme\\Deps\\TIMBER_LOADED')) {
            return;
        }
        $self = new self();
        $self->init_constants();
        ...
        \add_filter('theme_name_timber/post/import_data', [__CLASS__, 'handle_preview'], 10, 2);
        /**
         ...
         */
        \class_alias('Mwf\\ChildTheme\\Deps\\Timber\\Timber', 'Mwf\\ChildTheme\\Deps\\Timber');
        \define('Mwf\\ChildTheme\\Deps\\TIMBER_LOADED', \true);
    }
    /**
    ...
    public static function init_integrations() : void
    {
         ...
         */
        $integrations = \apply_filters('theme_name_timber/integrations', $integrations);
    ...
    public static function context_global()
    {
        if (empty(self::$context_cache)) {
             ...
             * @example
             * ```php
             * add_filter('theme_name_timber/context', function( $context ) {
             ...
             */
            self::$context_cache = \apply_filters('theme_name_timber/context', self::$context_cache);
            /**
             * Filters the global Timber context.
             *
    ...
    {
        if (!\defined('Mwf\\ChildTheme\\Deps\\TIMBER_LOADED')) {
            self::init();
        }
         ...
         */
        \do_action('theme_name_timber/calling_php_file', $caller_file);
        if ($via_render) {
            /**
             ...
             */
            $file = \apply_filters('theme_name_timber/render/file', $file);
            /**
             ...
             */
            $file = \apply_filters('theme_name_timber/compile/file', $file);
            /**
             * Filters the Twig template that should be compiled.
             *
             * @deprecated 2.0.0
        ...
        if ($file !== \false) {
            ...
            if ($via_render) {
                 ...
                 */
                $data = \apply_filters('theme_name_timber/render/data', $data, $file);
                /**
                 * Filters the data that should be passed for rendering a Twig template.
                 *
                 * @codeCoverageIgnore
                 ...
                 */
                $data = \apply_filters('theme_name_timber/compile/data', $data, $file);
                /**
                 * Filters the data that should be passed for compiling a Twig template.
                 *
         ...
         */
        $output = \apply_filters('theme_name_timber/compile/result', $output);
        /**
         ...
         */
        \do_action('theme_name_timber/compile/done', $output, $file, $data, $expires, $cache_mode);
        /**
         * Fires after a Twig template was compiled and before the compiled data
         * is returned.
         *
