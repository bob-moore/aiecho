...
class Term extends CoreEntity
{
    ...
    public function link()
    {
         ...
         */
        $link = \apply_filters('theme_name_timber/term/link', $link, $this);
        /**
         * Filters the link to the term archive page.
         *
    ...
    public function path()
    {
         ...
         *
         * ```
         * add_filter('theme_name_timber/term/path', function( $rel, $term ) {
         *     if ( $term->slug === 'news' ) {
         ...
         * @param Term $term The term object.
         */
        $rel = \apply_filters('theme_name_timber/term/path', $rel, $this);
        /**
         * Filters the relative link (path) to a term archive page.
         *
    ...
    public function update($key, $value)
    {
         ...
         * @deprecated 2.0.0, with no replacement
         */
        $value = \apply_filters_deprecated('theme_name_timber/term/meta/set', [$value, $key, $this->ID, $this], '2.0.0', \false, 'This filter will be removed in a future version of Timber. There is no replacement.');
        $this->{$key} = $value;
    }
}
