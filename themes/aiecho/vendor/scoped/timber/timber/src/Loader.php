...
use Mwf\ChildTheme\Deps\Twig\CacheExtension;
use Mwf\ChildTheme\Deps\Twig\Environment;
use Mwf\ChildTheme\Deps\Twig\Loader\FilesystemLoader;
...
class Loader
{
    ...
    public function __construct($caller = \false)
    {
         ...
         */
        $this->cache_mode = \apply_filters('theme_name_timber/cache/mode', $this->cache_mode);
        /**
         * Filters the cache mode.
         *
    ...
    public function render($file, $data = null, $expires = \false, $cache_mode = self::CACHE_USE_DEFAULT)
    {
        ...
        if (\false === $output || null === $output) {
            ...
            if (\strlen($file)) {
                 ...
                 * @param string $result
                 */
                \do_action('theme_name_timber/loader/render_file', $result);
                /**
                 * Fires after …
                 *
             ...
             * @param string $file
             */
            $data = \apply_filters('theme_name_timber/loader/render_data', $data, $file);
            /**
             * Filters …
             *
             * @todo Add summary
             ...
             * @param string $file
             */
            $output = \apply_filters('theme_name_timber/output/pre-cache', $output, $data, $file);
        }
         ...
         * @param string $file
         */
        $output = \apply_filters('theme_name_timber/output', $output, $data, $file);
        /**
         * Filters …
         *
         * @todo Add summary
    ...
    public function get_loader()
    {
         ...
         * @param array $paths
         */
        $paths = \apply_filters_deprecated('theme_name_timber/loader/paths', [$paths], '2.0.0', 'timber/locations');
         ...
         * @since 1.1.11
         */
        $fs = \apply_filters('theme_name_timber/loader/loader', $fs);
        return $fs;
    }
    /**
     * @return Environment
    ...
    public function get_twig()
    {
         ...
         * @example
         * ```php
         * add_filter('theme_name_timber/twig/environment/options', 'update_twig_environment_options' );
         *
         * /**
         ...
         */
        $environment_options = \apply_filters('theme_name_timber/twig/environment/options', $environment_options);
        /**
         * @deprecated 2.0.0
         */
        ...
        if (\true === $environment_options['cache']) {
             ...
             */
            $twig_cache_loc = \apply_filters_deprecated('theme_name_timber/cache/location', [$twig_cache_loc], '2.0.0', 'timber/twig/environment/options');
        ...
        if (\WP_DEBUG) {
            $twig->addExtension(new \Mwf\ChildTheme\Deps\Twig\Extension\DebugExtension());
        } else {
         ...
         */
        $enable_cache_extension = \apply_filters('theme_name_timber/cache/enable_extension', \true);
        if ($enable_cache_extension && \class_exists('Mwf\\ChildTheme\\Deps\\Twig\\CacheExtension\\Extension')) {
         ...
         */
        $twig = \apply_filters('theme_name_timber/loader/twig', $twig);
        /**
         * Filters …
         *
         ...
         *  *\/
         * add_filter('theme_name_timber/twig', function( $twig ) {
         ...
         */
        $twig = \apply_filters('theme_name_timber/twig', $twig);
        /**
         * Filters the Twig environment used in the global context.
         *
         * @deprecated 2.0.0
    ...
    private function _get_cache_extension()
    {
        ...
        $cache_lifetime = \apply_filters('theme_name_timber/cache/extension/lifetime', 0);
    ...
    public function get_cache($key, $group = self::CACHEGROUP, $cache_mode = self::CACHE_USE_DEFAULT)
    {
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/cache/transient_key', function( $trans_key, $key, $group, $cache_mode ) {
         ...
         */
        $trans_key = \apply_filters('theme_name_timber/cache/transient_key', $trans_key, $key, $group, $cache_mode);
