...
class PostExcerpt
{
    ...
    public function __construct($post, array $options = [])
    {
         ...
         * @example
         * ```php
         * add_filter('theme_name_timber/post/excerpt/defaults', function( $defaults ) {
         ...
         */
        $defaults = \apply_filters('theme_name_timber/post/excerpt/defaults', $defaults);
    ...
    protected function assemble($text, $args = [])
    {
        ...
        if ($this->read_more && ($this->always_add_read_more || $args['add_read_more'])) {
             ...
             * add_filter('theme_name_timber/post/excerpt/read_more_class', function( $class ) {
             ...
             */
            $read_more_class = \apply_filters('theme_name_timber/post/excerpt/read_more_class', 'read-more');
            /**
             * Filters the CSS class used for excerpt links.
             *
             * @deprecated 2.0.0
             * @since 1.0.4
             */
            $read_more_class = \apply_filters_deprecated('theme_name_timber/post/preview/read_more_class', [$read_more_class], '2.0.0', 'timber/post/excerpt/read_more_class');
             ...
             */
            $link = \apply_filters('theme_name_timber/post/excerpt/read_more_link', $link, $this->post, $linktext, $read_more_class);
            /**
             * Filters the link used for a read more text in an excerpt.
             *
             * @deprecated 2.0.0
             ...
             * @ticket #1142
             */
            $link = \apply_filters_deprecated('theme_name_timber/post/get_preview/read_more_link', [$link], '2.0.0', 'timber/post/excerpt/read_more_link');
            $text .= $link;
        }
