...
class URLHelper
{
    ...
    public static function url_to_file_system($url)
    {
         ...
         */
        $url_parts['path'] = \apply_filters('theme_name_timber/url_helper/url_to_file_system/path', $url_parts['path']);
        /**
         * Filters the path of a parsed URL.
         *
         * @deprecated 2.0.0, use `timber/url_helper/url_to_file_system/path`
         */
        $url_parts['path'] = \apply_filters_deprecated('theme_name_timber/URLHelper/url_to_file_system/path', [$url_parts['path']], '2.0.0', 'timber/url_helper/url_to_file_system/path');
    ...
    public static function file_system_to_url($fs)
    {
         ...
         */
        $url = \apply_filters('theme_name_timber/url_helper/file_system_to_url', $url);
        /**
         * Filters the URL in URLHelper::file_system_to_url
         *
         * You can use this filter to alter the returned URL.
         ...
         */
        $url = \apply_filters_deprecated('theme_name_timber/URLHelper/file_system_to_url', [$url], '2.0.0', 'timber/url_helper/file_system_to_url');
        return $url;
    }
    /**
    ...
    public static function get_content_subdir()
    {
         ...
         */
        $home_url = \apply_filters('theme_name_timber/url_helper/get_content_subdir/home_url', $home_url);
        /**
         * Filters the home URL that is used to get the path relative to the content directory.
         *
         * @deprecated 2.0.0, use `timber/url_helper/get_content_subdir/home_url`
         */
        $home_url = \apply_filters_deprecated('theme_name_timber/URLHelper/get_content_subdir/home_url', [$home_url], '2.0.0', 'timber/url_helper/get_content_subdir/home_url');
    ...
    public static function remove_double_slashes($url)
    {
         ...
         */
        $schemes_whitelist = \apply_filters('theme_name_timber/url/schemes-whitelist', ['http', 'https', 's3', 'gs']);
