...
namespace Mwf\ChildTheme\Deps\Timber\Image\Operation;

use Imagick;
use Mwf\ChildTheme\Deps\Timber\Helper;
use Mwf\ChildTheme\Deps\Timber\Image\Operation as ImageOperation;
use Mwf\ChildTheme\Deps\Timber\ImageHelper;
use WP_Image_Editor;
/**
...
class Resize extends ImageOperation
{
    ...
    protected function run_animated_gif($load_filename, $save_filename, WP_Image_Editor $editor)
    {
        $w = $this->w;
        $h = $this->h;
        if (!\class_exists('Imagick') || \defined('Mwf\\ChildTheme\\Deps\\TEST_NO_IMAGICK') && TEST_NO_IMAGICK) {
