...
class LocationManager
{
    ...
    public static function get_locations($caller = \false)
    {
        ...
        $locs = \array_merge_recursive($locs, self::get_locations_caller($caller, \true));
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/locations', function( $locs ) {
         *   $locs = \array_map(function ($loc) {
         ...
         */
        $locs = \apply_filters('theme_name_timber/locations', $locs);
        /**
         * Filters the filesystem paths to search for Twig templates.
         *
    ...
    /**
     * @deprecated since 2.0.0 Use `add_filter('theme_name_timber/locations', $locations)` instead.
     * @return array
     */
