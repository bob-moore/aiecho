...
class Post extends CoreEntity implements DatedInterface, Setupable
{
    ...
    public static function build(WP_Post $wp_post) : self
    {
         ...
         */
        $data = \apply_filters('theme_name_timber/post/import_data', $data, $post);
        $post->import($data);
        return $post;
    }
    /**
    ...
    public function field_object($field_name)
    {
         ...
         */
        $value = \apply_filters('theme_name_timber/post/meta_object_field', null, $this->ID, $field_name, $this);
    ...
    public function authors()
    {
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/post/authors', function( $author, $post ) {
         ...
         * @param Post $post    The post object.
         */
        return \apply_filters('theme_name_timber/post/authors', [$this->author()], $this);
    }
    /**
    ...
    public function children($args = 'any')
    {
        if (\is_string($args) || \array_values($args) === $args) {
            $args = ['post_type' => 'parent' === $args ? $this->post_type : $args];
        }
        $args = \wp_parse_args($args, ['post_parent' => $this->ID, 'post_type' => 'any', 'posts_per_page' => -1, 'orderby' => 'menu_order title', 'order' => 'ASC', 'post_status' => 'publish' === $this->post_status ? ['publish', 'inherit'] : 'publish']);
        /**
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/post/children_args', function( $args, $post ) {
         *
         ...
         * @param Post $post   The post object.
         */
        $args = \apply_filters('theme_name_timber/post/children_args', $args, $this);
    ...
    protected function maybe_show_password_form()
    {
        if ($this->password_required()) {
             ...
             * add_filter('theme_name_timber/post/content/show_password_form_for_protected', '__return_true' );
             * ```
             *
             * @param bool $show_pw Whether the password form should be shown. Default `false`.
             */
            $show_pw = \apply_filters('theme_name_timber/post/content/show_password_form_for_protected', $show_pw);
            if ($show_pw) {
                /**
                 ...
                 * add_filter('theme_name_timber/post/content/password_form', function( $form, $post ) {
                 ...
                 * @param Post $post The post object.
                 */
                return \apply_filters('theme_name_timber/post/content/password_form', \get_the_password_form($this->ID), $this);
            }
        }
    }
    /**
