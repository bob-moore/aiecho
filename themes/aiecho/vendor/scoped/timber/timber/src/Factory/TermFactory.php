...
use Mwf\ChildTheme\Deps\Timber\Term;
use WP_Term;
use WP_Term_Query;
/**
...
class TermFactory
{
    ...
    protected function get_term_class(WP_Term $term) : string
    {
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/term/classmap', function( $classmap ) {
         *     $custom_classmap = [
         ...
         */
        $map = \apply_filters('theme_name_timber/term/classmap', ['post_tag' => Term::class, 'category' => Term::class]);
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/term/class', function( $class, $term ) {
         ...
         */
        $class = \apply_filters('theme_name_timber/term/class', $class, $term);
        return $class;
    }
