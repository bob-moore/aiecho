...
namespace Mwf\ChildTheme\Deps\Timber\Factory;

use InvalidArgumentException;
use Mwf\ChildTheme\Deps\Timber\Attachment;
use Mwf\ChildTheme\Deps\Timber\CoreInterface;
use Mwf\ChildTheme\Deps\Timber\Helper;
use Mwf\ChildTheme\Deps\Timber\Image;
use Mwf\ChildTheme\Deps\Timber\PathHelper;
use Mwf\ChildTheme\Deps\Timber\Post;
use Mwf\ChildTheme\Deps\Timber\PostArrayObject;
use Mwf\ChildTheme\Deps\Timber\PostQuery;
use WP_Post;
use WP_Query;
/**
...
class PostFactory
{
    ...
    protected function get_post_class(WP_Post $post) : string
    {
         ...
         */
        if ('deprecated' !== \apply_filters('Mwf\\ChildTheme\\Deps\\Timber\\PostClassMap', 'deprecated')) {
         ...
         * use Page;
         *
         * add_filter('theme_name_timber/post/classmap', function( $classmap ) {
         *     $custom_classmap = [
         *         'page' => Page::class,
         *         'book' => Book::class,
         *     ];
         ...
         */
        $classmap = \apply_filters('theme_name_timber/post/classmap', [
            'post' => Post::class,
            'page' => Post::class,
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/post/class', function( $class, $post ) {
         *     if ( has_blocks($post) ) {
         ...
         */
        $class = \apply_filters('theme_name_timber/post/class', $class, $post);
        return $class;
    }
    protected function is_image(WP_Post $post)
    {
         ...
         * @since 2.0.0
         */
        $extensions = \apply_filters('theme_name_timber/post/image_extensions', ['jpg', 'jpeg', 'jpe', 'gif', 'png', 'svg', 'webp']);
