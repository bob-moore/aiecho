...
use Mwf\ChildTheme\Deps\Timber\PagesMenu;
/**
...
class PagesMenuFactory
{
    ...
    protected function get_menu_class($args) : string
    {
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/pages_menu/class', function( $class ) {
         ...
         */
        $class = \apply_filters('theme_name_timber/pages_menu/class', PagesMenu::class, $args);
