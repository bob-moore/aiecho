...
use Mwf\ChildTheme\Deps\Timber\Comment;
...
class CommentFactory
{
    ...
    protected function get_comment_class(WP_Comment $comment) : string
    {
         ...
         */
        $map = \apply_filters('theme_name_timber/comment/classmap', []);
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/comment/class', function( $class, $comment ) {
         ...
         */
        $class = \apply_filters('theme_name_timber/comment/class', $class, $comment);
        return $class;
    }
