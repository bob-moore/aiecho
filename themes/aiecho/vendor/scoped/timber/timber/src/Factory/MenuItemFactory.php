...
use Mwf\ChildTheme\Deps\Timber\Menu;
use Mwf\ChildTheme\Deps\Timber\MenuItem;
use WP_Post;
/**
...
class MenuItemFactory
{
    ...
    protected function get_menuitem_class(WP_Post $item, Menu $menu) : string
    {
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/menuitem/classmap', function( $classmap ) {
         *     $custom_classmap = [
         ...
         */
        $classmap = \apply_filters('theme_name_timber/menuitem/classmap', []);
         ...
         * @example
         * ```
         * add_filter('theme_name_timber/menuitem/class', function( $class, $item, $menu ) {
         *     if ( $item->post_parent ) {
         ...
         */
        $class = \apply_filters('theme_name_timber/menuitem/class', $class, $item, $menu);
        return $class;
    }
}
