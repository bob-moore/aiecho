...
use Exception;
use Mwf\ChildTheme\Deps\Timber\Factory\PostFactory;
use Mwf\ChildTheme\Deps\Timber\Factory\TermFactory;
...
class Twig
{
    ...
    {
        $self = new self();
        \add_filter('theme_name_timber/twig', [$self, 'add_timber_functions']);
        \add_filter('theme_name_timber/twig', [$self, 'add_timber_filters']);
        \add_filter('theme_name_timber/twig', [$self, 'add_timber_escaper_filters']);
        \add_filter('theme_name_timber/twig', [$self, 'add_timber_escapers']);
        \add_filter('theme_name_timber/loader/twig', [$self, 'set_defaults']);
    }
    /**
    ...
    public function get_timber_functions()
    {
         ...
         * @example
         * ```php
         * add_filter('theme_name_timber/twig/functions', function( $functions ) {
         ...
         */
        $functions = \apply_filters('theme_name_timber/twig/functions', $functions);
        return $functions;
    }
    /**
    ...
    public function get_timber_filters()
    {
        $filters = [
            /* image filters */
            'resize' => ['callable' => ['Mwf\\ChildTheme\\Deps\\Timber\\ImageHelper', 'resize']],
            'retina' => ['callable' => ['Mwf\\ChildTheme\\Deps\\Timber\\ImageHelper', 'retina_resize']],
            'letterbox' => ['callable' => ['Mwf\\ChildTheme\\Deps\\Timber\\ImageHelper', 'letterbox']],
            'tojpg' => ['callable' => ['Mwf\\ChildTheme\\Deps\\Timber\\ImageHelper', 'img_to_jpg']],
            'towebp' => ['callable' => ['Mwf\\ChildTheme\\Deps\\Timber\\ImageHelper', 'img_to_webp']],
            // Debugging filters.
            ...
            'excerpt_chars' => ['callable' => ['Mwf\\ChildTheme\\Deps\\Timber\\TextHelper', 'trim_characters']],
            'function' => ['callable' => [$this, 'exec_function']],
            ...
            'pluck' => ['callable' => ['Mwf\\ChildTheme\\Deps\\Timber\\Helper', 'pluck']],
            'wp_list_filter' => ['callable' => ['Mwf\\ChildTheme\\Deps\\Timber\\Helper', 'wp_list_filter']],
            ...
            'time_ago' => ['callable' => ['Mwf\\ChildTheme\\Deps\\Timber\\DateTimeHelper', 'time_ago']],
         ...
         * @example
         * ```php
         * add_filter('theme_name_timber/twig/default_filters', function( $filters ) {
         *     // Add your own filter.
         *     $filters['price'] = [
         ...
         * @param array $filters
         */
        $filters = \apply_filters('theme_name_timber/twig/filters', $filters);
        return $filters;
    }
    /**
     * Get Timber default filters
    ...
    {
        $escaper_filters = ['esc_url' => ['callable' => 'esc_url'], 'wp_kses' => ['callable' => 'wp_kses'], 'wp_kses_post' => ['callable' => 'wp_kses_post'], 'esc_attr' => ['callable' => 'esc_attr'], 'esc_html' => ['callable' => 'esc_html'], 'esc_js' => ['callable' => 'esc_js']];
        /**
         ...
         * @example
         * ```php
         * add_filter('theme_name_timber/twig/escapers', function( $escaper_filters ) {
         *     // Add your own filter.
         *     $filters['esc_xml'] = [
         *         'callable' => 'esc_xml',
         *          'options' => [
         ...
         */
        $escaper_filters = \apply_filters('theme_name_timber/twig/escapers', $escaper_filters);
    ...
    public function add_timber_escaper_filters($twig)
    {
        foreach ($this->get_timber_escaper_filters() as $name => $function) {
            $twig->addFilter(new TwigFilter($name, $function['callable'], $function['options'] ?? ['is_safe' => ['html']]));
        }
        return $twig;
    }
    /**
    ...
    public function add_timber_escapers($twig)
    {
        ...
        if (\class_exists('Mwf\\ChildTheme\\Deps\\Twig\\Extension\\EscaperExtension')) {
            $escaper_extension = $twig->getExtension('Mwf\\ChildTheme\\Deps\\Twig\\Extension\\EscaperExtension');
