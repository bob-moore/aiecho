...
class Helper
{
    ...
    public static function transient($slug, $callback, $transient_time = 0, $lock_timeout = 5, $force = \false)
    {
         ...
         */
        $slug = \apply_filters('theme_name_timber/transient/slug', $slug);
        $enable_transients = $transient_time === \false || \defined('Mwf\\ChildTheme\\Deps\\WP_DISABLE_TRANSIENTS') && WP_DISABLE_TRANSIENTS ? \false : \true;
    ...
    protected static function handle_transient_locking($slug, $callback, $transient_time, $lock_timeout, $force, $enable_transients)
    {
        if ($enable_transients && self::_is_transient_locked($slug)) {
             ...
             */
            $force = \apply_filters('theme_name_timber/transient/force_transients', $force);
            /**
             * Filters whether to force a locked transients to be regenerated.
             *
             * If a transient is locked, it means that another process is currently generating the data.
             ...
             * ```php
             *
             * add_filter('theme_name_timber/transient/force_transient_mycustumslug', function($force) {
             ...
             */
            $force = \apply_filters_deprecated("timber_force_transient_{$slug}", [$force], '2.0.0', "timber/transient/force_transient_{$slug}");
            if (!$force) {
    ...
    public static function get_wp_title($separator = ' ', $seplocation = 'left')
    {
         ...
         */
        $separator = \apply_filters('theme_name_timber/helper/wp_title_separator', $separator);
        /**
         * Filters the separator used for the page title.
         *
