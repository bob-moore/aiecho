 ...
 * @since   1.0.0
 */
namespace Mwf\ChildTheme\Deps\Devkit\WPCore\Controllers;

use Mwf\ChildTheme\Deps\Devkit\WPCore\DI\ContainerBuilder, Mwf\ChildTheme\Deps\Devkit\WPCore\Abstracts, Mwf\ChildTheme\Deps\Devkit\WPCore\Interfaces, Mwf\ChildTheme\Deps\Devkit\WPCore\DI\OnMount, Mwf\ChildTheme\Deps\Devkit\WPCore\Services, Mwf\ChildTheme\Deps\Devkit\WPCore\Helpers, Mwf\ChildTheme\Deps\Devkit\WPCore\Main, Mwf\ChildTheme\Deps\Devkit\WPCore\Routes as Route;
/**
...
class Router extends Abstracts\Mountable implements Interfaces\Controller
{
    ...
    {
        return [Services\Router::class => ContainerBuilder::autowire(), Interfaces\Services\Router::class => ContainerBuilder::get(Services\Router::class), 'route' => ContainerBuilder::array(['frontend' => ContainerBuilder::autowire(Route\Frontend::class), 'admin' => ContainerBuilder::autowire(Route\Frontend::class), 'login' => ContainerBuilder::autowire(Route\Frontend::class)])];
    }
    /**
    ...
    {
        return \apply_filters("{$this->package}_has_route", Main::hasService($route_alias, $this->package), $route_alias);
    }
    /**
