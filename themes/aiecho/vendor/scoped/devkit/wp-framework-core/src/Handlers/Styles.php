 ...
 * @since   1.0.0
 */
namespace Mwf\ChildTheme\Deps\Devkit\WPCore\Handlers;

use Mwf\ChildTheme\Deps\DI\Attribute\Inject, Mwf\ChildTheme\Deps\Devkit\WPCore\Abstracts, Mwf\ChildTheme\Deps\Devkit\WPCore\Interfaces, Mwf\ChildTheme\Deps\Devkit\WPCore\Traits;
/**
 ...
 * @internal
 */
class Styles extends Abstracts\Mountable implements Interfaces\Handlers\Styles, Interfaces\Handlers\Directory, Interfaces\Handlers\Url
{
    ...
    public function register(string $handle, string $path, array $dependencies = [], string $version = null, $screens = 'all') : string
    {
        ...
        \wp_register_style($package_handle ?? $handle, $path, \apply_filters("{$this->package}_{$handle}_style_dependencies", $dependencies), $version, $screens);
