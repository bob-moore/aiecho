...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Environment;\n")->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Error\\LoaderError;\n")->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Error\\RuntimeError;\n")->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Extension\\SandboxExtension;\n")->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Markup;\n")->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Sandbox\\SecurityError;\n")->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Sandbox\\SecurityNotAllowedTagError;\n")->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Sandbox\\SecurityNotAllowedFilterError;\n")->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Sandbox\\SecurityNotAllowedFunctionError;\n")->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Source;\n")->write("use \\Mwf\\ChildTheme\\Deps\\Twig\\Template;\n\n");
        }
        $compiler->write('/* ' . \str_replace('*/', '* /', $this->getSourceContext()->getName()) . " */\n")->write('class ' .  \substr( $compiler->getEnvironment()->getTemplateClass($this->getSourceContext()->getName(), $this->getAttribute('index')), 21 ) )->raw(" extends Template\n")->write("{\n")->indent()->write("private \$source;\n")->write("private \$macros = [];\n\n");
    }
