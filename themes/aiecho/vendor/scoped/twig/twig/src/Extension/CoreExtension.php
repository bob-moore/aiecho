...
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\AddBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\AndBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\BitwiseAndBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\BitwiseOrBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\BitwiseXorBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\ConcatBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\DivBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\EndsWithBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\EqualBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\FloorDivBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\GreaterBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\GreaterEqualBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\HasEveryBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\HasSomeBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\InBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\LessBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\LessEqualBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\MatchesBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\ModBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\MulBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\NotEqualBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\NotInBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\OrBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\PowerBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\RangeBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\SpaceshipBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\StartsWithBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Binary\SubBinary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Filter\DefaultFilter;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\NullCoalesceExpression;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Test\ConstantTest;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Test\DefinedTest;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Test\DivisiblebyTest;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Test\EvenTest;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Test\NullTest;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Test\OddTest;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Test\SameasTest;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Unary\NegUnary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Unary\NotUnary;
use Mwf\ChildTheme\Deps\Twig\Node\Expression\Unary\PosUnary;
use Mwf\ChildTheme\Deps\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use Mwf\ChildTheme\Deps\Twig\TokenParser\ApplyTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\BlockTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\DeprecatedTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\DoTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\EmbedTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\ExtendsTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\FlushTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\ForTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\FromTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\IfTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\ImportTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\IncludeTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\MacroTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\SetTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\UseTokenParser;
use Mwf\ChildTheme\Deps\Twig\TokenParser\WithTokenParser;
...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            // formatting filters
            new TwigFilter('date', '\\Mwf\\ChildTheme\\Deps\\twig_date_format_filter', ['needs_environment' => \true]),
            new TwigFilter('date_modify', '\\Mwf\\ChildTheme\\Deps\\twig_date_modify_filter', ['needs_environment' => \true]),
            new TwigFilter('format', '\\Mwf\\ChildTheme\\Deps\\twig_sprintf'),
            new TwigFilter('replace', '\\Mwf\\ChildTheme\\Deps\\twig_replace_filter'),
            new TwigFilter('number_format', '\\Mwf\\ChildTheme\\Deps\\twig_number_format_filter', ['needs_environment' => \true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', '\\Mwf\\ChildTheme\\Deps\\twig_round'),
            // encoding
            new TwigFilter('url_encode', '\\Mwf\\ChildTheme\\Deps\\twig_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', '\\Mwf\\ChildTheme\\Deps\\twig_convert_encoding'),
            // string filters
            new TwigFilter('title', '\\Mwf\\ChildTheme\\Deps\\twig_title_string_filter', ['needs_environment' => \true]),
            new TwigFilter('capitalize', '\\Mwf\\ChildTheme\\Deps\\twig_capitalize_string_filter', ['needs_environment' => \true]),
            new TwigFilter('upper', '\\Mwf\\ChildTheme\\Deps\\twig_upper_filter', ['needs_environment' => \true]),
            new TwigFilter('lower', '\\Mwf\\ChildTheme\\Deps\\twig_lower_filter', ['needs_environment' => \true]),
            new TwigFilter('striptags', '\\Mwf\\ChildTheme\\Deps\\twig_striptags'),
            new TwigFilter('trim', '\\Mwf\\ChildTheme\\Deps\\twig_trim_filter'),
            new TwigFilter('nl2br', '\\Mwf\\ChildTheme\\Deps\\twig_nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', '\\Mwf\\ChildTheme\\Deps\\twig_spaceless', ['is_safe' => ['html']]),
            // array helpers
            new TwigFilter('join', '\\Mwf\\ChildTheme\\Deps\\twig_join_filter'),
            new TwigFilter('split', '\\Mwf\\ChildTheme\\Deps\\twig_split_filter', ['needs_environment' => \true]),
            new TwigFilter('sort', '\\Mwf\\ChildTheme\\Deps\\twig_sort_filter', ['needs_environment' => \true]),
            new TwigFilter('merge', '\\Mwf\\ChildTheme\\Deps\\twig_array_merge'),
            new TwigFilter('batch', '\\Mwf\\ChildTheme\\Deps\\twig_array_batch'),
            new TwigFilter('column', '\\Mwf\\ChildTheme\\Deps\\twig_array_column'),
            new TwigFilter('filter', '\\Mwf\\ChildTheme\\Deps\\twig_array_filter', ['needs_environment' => \true]),
            new TwigFilter('map', '\\Mwf\\ChildTheme\\Deps\\twig_array_map', ['needs_environment' => \true]),
            new TwigFilter('reduce', '\\Mwf\\ChildTheme\\Deps\\twig_array_reduce', ['needs_environment' => \true]),
            // string/array filters
            new TwigFilter('reverse', '\\Mwf\\ChildTheme\\Deps\\twig_reverse_filter', ['needs_environment' => \true]),
            new TwigFilter('length', '\\Mwf\\ChildTheme\\Deps\\twig_length_filter', ['needs_environment' => \true]),
            new TwigFilter('slice', '\\Mwf\\ChildTheme\\Deps\\twig_slice', ['needs_environment' => \true]),
            new TwigFilter('first', '\\Mwf\\ChildTheme\\Deps\\twig_first', ['needs_environment' => \true]),
            new TwigFilter('last', '\\Mwf\\ChildTheme\\Deps\\twig_last', ['needs_environment' => \true]),
            // iteration and runtime
            new TwigFilter('default', '\\Mwf\\ChildTheme\\Deps\\_twig_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', '\\Mwf\\ChildTheme\\Deps\\twig_get_array_keys_filter'),
        ];
    }
...
use Mwf\ChildTheme\Deps\Twig\Error\LoaderError;
use Mwf\ChildTheme\Deps\Twig\Error\RuntimeError;
use Mwf\ChildTheme\Deps\Twig\Extension\CoreExtension;
use Mwf\ChildTheme\Deps\Twig\Extension\SandboxExtension;
use Mwf\ChildTheme\Deps\Twig\Markup;
use Mwf\ChildTheme\Deps\Twig\Source;
use Mwf\ChildTheme\Deps\Twig\Template;
use Mwf\ChildTheme\Deps\Twig\TemplateWrapper;
/**
 * Cycles over a value.
 *
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('Mwf\\ChildTheme\\Deps\\Twig\\Extension\\SandboxExtension') && $env->getExtension('Mwf\\ChildTheme\\Deps\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
